...
public class PlacesListAdapter extends ArrayAdapter<PlacesListAdapter.PlaceAutocomplete> implements Filterable {
     ...
     */
    public PlacesListAdapter(Context context, int resource, RectangularBounds bounds) {
