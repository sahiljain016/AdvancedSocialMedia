 ...
 * customize these behaviors by overriding {@link Callback#onChildDraw(Canvas, RecyclerView, ViewHolder, float, float, int, boolean)} (Canvas, RecyclerView, *
 * RecyclerView.ViewHolder , float, float, int, boolean)}
 * or {@link Callback#onChildDrawOver(Canvas, RecyclerView, ViewHolder, float, float, int, boolean)} (Canvas, RecyclerView, RecyclerView.ViewHolder, float, float, int, *
 * boolean)}.
 * <p/>
...
//    public static final int DOWN = 1 << 1;
     ...
     * {@link Callback#getAbsoluteMovementFlags(RecyclerView, ViewHolder)} (RecyclerView, RecyclerView.View
...
//    }
    ...
    @SuppressWarnings("UnusedParameters") public abstract static class Callback {
         ...
         * @param directions The direction flags. Can be composed from , ,
         ...
         * <p>
         * Instead of composing this flag manually, you can use {@link #makeMovementFlags(int, int)} (int, * int)}
         ...
         * moved to.
         */
        public ViewHolder chooseDropTarget(RecyclerView.ViewHolder selected, List<RecyclerView.ViewHolder> dropTargets, int curX,
                                           int curY) {
         ...
         * {@link #onChildDraw(Canvas, RecyclerView, ViewHolder, float, float, int, boolean)} (Canvas, RecyclerView, ViewHolder, float, float, int, * boolean)} or
         ...
         * is
         * achieved via {@link android.view.ViewGroup#getChildDrawingOrder(int)} (int, int)} and on L
         ...
         * @see #onChildDrawOver(Canvas, RecyclerView, ViewHolder, float, float, int, boolean) (Canvas, RecyclerView, ViewHolder, float, float, int, * boolean)
         */
