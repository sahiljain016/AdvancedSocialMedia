package com.gic.memorableplaces.CustomLibs.BlurKit;
...
public class RoundedImageView extends androidx.appcompat.widget.AppCompatImageView {
    ...
    private float mCornerRadius = 0, mTopLeftCornerRadius = 0, mTopRightCornerRadius = 0, mBottomLeftCornerRadius = 0, mBottomRightCornerRadius = 0;
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (myDrawable != null && myDrawable instanceof BitmapDrawable &&
                (mCornerRadius > 0 || mTopLeftCornerRadius > 0 || mTopRightCornerRadius > 0
            ...
            else if (mTopLeftCornerRadius > 0 || mTopRightCornerRadius > 0
                    || mBottomLeftCornerRadius > 0 || mBottomRightCornerRadius > 0)
                canvas.drawRoundRect(rectF, mCornerRadius, mCornerRadius, paint);
